    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image" style="background-image: url('/img/register.jpeg');"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email"
                                        ...
                                        <small id="emailHelp" class="form-text text-muted" style="padding-left: 16px;"><?=lang('Auth.weNeverShare')?></small>
                                </div>
